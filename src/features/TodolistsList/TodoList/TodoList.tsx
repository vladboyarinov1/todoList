...
import { FilterValueType } from "../todolists-reducer/todolists-reducer";
...
import { TaskType, TodolistType } from "common/types/commonTypes";
...
export const TodoList: FC<TodoListPropsType> = memo(
    ({ todolist, entityStatus }) => {
        ...
        const { deleteTodolistTC, changeTodolistFilter, updateTodolistTC } =
        ...
        const getFilterValues = useCallback(
            (tasksList: Array<TaskType>, filterValue: FilterValueType) => {
                switch (filterValue) {
                    case "active":
