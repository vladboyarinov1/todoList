...
export const GetTodolists = () => {
    ...
    useEffect(() => {
        ...
        TodolistApi.getTodolists().then((response) => setState(response.data)); // есть второй параметр callback нужен для того чтобы отловить ошибку если promise reject. Но обвчно обрабатывают через  catch
    }, []);
...
export const DeleteTodolist = () => {
    ...
    useEffect(() => {
        ...
        TodolistApi.deleteTodolist(todolistId).then((response) => setState(response.data));
    }, []);
    return <div>{JSON.stringify(state)}</div>;
};
...
export const UpdateTodolistTitle = () => {
    ...
    useEffect(() => {
        ...
        TodolistApi.updateTodolistTitle(todolistId, title).then((response) => setState(response.data));
    }, []);
...
export const GetTasks = () => {
    ...
    useEffect(() => {
        ...
        TodolistApi.getTasks(todolistId).then((response) => setState(response.data));
    }, []);
